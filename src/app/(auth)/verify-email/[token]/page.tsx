  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-40">
      <div className="flex flex-col items-center text-center max-w-md w-full">
        ...
        <div className="mb-8 relative flex items-center justify-center h-40">
          ...
          <svg width="160" height="160" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="relative">
            ...
            {result.success ? 
                ...
                <>
                {/* Fail badge */}
                    <circle cx="106" cy="128" r="20" fill="white" stroke="#FFE0E0" strokeWidth="1.5"/>
                    <circle cx="106" cy="128" r="13" fill="#EF4444"/>
                    <path d="M101 123 L111 133 M111 123 L101 133" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
                </>
            }
            {/* Decorative dots */}
        ...
        {/* Heading */}
        <h1 className="text-4xl font-extrabold text-gray-800 mb-3">{result.success ? "Email Verified" : "Verification Failed"}</h1>

        {/* Subtext */}
        <p className="max-sm:text-sm text-gray-600 leading-relaxed mb-8">{result.message}</p>
