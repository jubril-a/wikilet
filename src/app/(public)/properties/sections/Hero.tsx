export default function Hero({title, city, country, bgImage}: {title: string, city: string, country: string, bgImage: string}) {
    return (
        <header className="grid place-content-center h-screen sm:min-h-160 bg-cover bg-center relative px-4" style={{ backgroundImage: `url(${bgImage})` }}>
            <div className="bg-black/70 text-center max-w-160 p-8 min-[640px]:p-16 relative z-5 rounded-md">
