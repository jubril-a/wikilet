...
export default function CheckAvailability() {
    ...
    return (   
        <div>
            <div className="px-4 py-8 max-w-200 mx-auto min-[720px]:flex gap-4 items-center min-[640px]:px-8">
                <div>
                ...
                <div className="bg-black w-full max-w-84 shrink-0 px-8 py-12 text-white grid gap-5 rounded-3xl relative z-5">
                    ...
                    <a href="/book" className="bg-gray-600 rounded-md text-center text-white py-3 cursor-pointer hover:bg-primary-2 hover:text-primary-1 text-sm font-semibold">Check</a>
                </div>
            </div>
        </div>
    )
