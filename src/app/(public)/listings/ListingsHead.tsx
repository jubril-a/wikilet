...
export default function ListingsHead({ length, state }: {length: number, state:[boolean, Dispatch<SetStateAction<boolean>>]}) {
    ...
    return (
        <>
            <div className="flex justify-between items-center gap-4 border-b border-gray-200 py-4 mb-6 flex-wrap">
                <h2 className="text-xl font-bold shrink-0">{length || "No"} Properties found</h2>
